...
<fieldset>
    ...
    <p>
        <img src="<{xoModuleIcons16 1.png}>" title="<{$smarty.const._AM_WFDOWNLOADS_AREVIEWS_APPROVE}>"
             alt="<{$smarty.const._AM_WFDOWNLOADS_AREVIEWS_APPROVE}>"/> <{$smarty.const._AM_WFDOWNLOADS_AREVIEWS_APPROVE}>
        <br/>
        <img src="<{xoModuleIcons16 edit.png}>" title="<{$smarty.const._AM_WFDOWNLOADS_AREVIEWS_EDIT}>"
             alt="<{$smarty.const._AM_WFDOWNLOADS_AREVIEWS_EDIT}>"/> <{$smarty.const._AM_WFDOWNLOADS_AREVIEWS_EDIT}>
        <br/>
        <img src="<{xoModuleIcons16 delete.png}>" title="<{$smarty.const._AM_WFDOWNLOADS_AREVIEWS_DELETE}>"
             alt="<{$smarty.const._AM_WFDOWNLOADS_AREVIEWS_DELETE}>"/> <{$smarty.const._AM_WFDOWNLOADS_AREVIEWS_DELETE}>
    </p>
</fieldset>
