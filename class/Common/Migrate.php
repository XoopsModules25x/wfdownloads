...
class Migrate extends \Xmf\Database\Migrate
{
    ...
    /**
     * Migrate constructor.
     * @param \XoopsModules\Wfdownloads\Common\Configurator $configurator
     */
    public function __construct(Wfdownloads\Common\Configurator $configurator)
    {
    ...
    /**
     * Move do* columns from wfdownloads_posts to wfdownloads_posts_text table
     */
    ...
    {
        // change 'bb' table prefix to 'wfdownloads'
        $this->changePrefix();
        ...
        $this->convertIPAddresses('wfdownloads_posts', 'poster_ip');
        $this->convertIPAddresses('wfdownloads_report', 'reporter_ip');
    }
}
