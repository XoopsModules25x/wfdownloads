...
define('_AM_WFDOWNLOADS_ERROR_DOWNLOADNOTFOUND', 'Download not found');
define('_AM_WFDOWNLOADS_ERROR_MIMETYPENOTFOUND', 'MIME Type not found');
define('_AM_WFDOWNLOADS_ERROR_MIRRORNOTFOUND', 'Mirror not found');
...
define('_AM_WFDOWNLOADS_DB_MSG_RENAME_TABLE_ERR', 'Rename Table Error');
