...
<{if $show_screenshot === true}>
    <div>
        <{if $download.screenshots.0.filename|default:'' != ''}>
            <div>
        ...
        <{/if}>
        <{if $download.screenshots.1.filename|default:'' != '' && $viewcat !== true}>
            <div>
        ...
        <{/if}>
        <{if $download.screenshots.2.filename|default:'' != '' && $viewcat !== true}>
            <div>
        ...
        <{/if}>
        <{if $download.screenshots.3.filename|default:'' != '' && $viewcat !== true}>
            <div>
